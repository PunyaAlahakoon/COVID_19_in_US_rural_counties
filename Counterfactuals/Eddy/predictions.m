...
save('EDDY_case_paths.mat','predicted_case_paths')
save('EDDY_predicted_total_deaths.mat','predicted_total_deaths')

save('EDDY_case_paths_2W_20.mat','case_paths_2W_20')
save('EDDY_total_deaths_2W_20.mat','total_deaths_2W_20')

save("EDDY_case_paths_2W_60.mat","case_paths_2W_60")
save("EDDY_total_deaths_2W_60.mat","total_deaths_2W_60")

save("EDDY_case_paths_2W_80.mat","case_paths_2W_80")
save("EDDY_total_deaths_2W_80.mat","total_deaths_2W_80")

save("EDDY_case_paths_4W_20.mat","case_paths_4W_20")
save("EDDY_total_deaths_4W_20.mat","total_deaths_4W_20")

save("EDDY_case_paths_4W_60.mat","case_paths_4W_60")
save("EDDY_total_deaths_4W_60.mat",'total_deaths_4W_60')

save("EDDY_case_paths_4W_80.mat","case_paths_4W_80")
save("EDDY_total_deaths_4W_80.mat","total_deaths_4W_80")

save("EDDY_case_paths_2M_20.mat","case_paths_2M_20")
save("EDDY_total_deaths_2M_20.mat","total_deaths_2M_20")

save("EDDY_case_paths_2M_60.mat","case_paths_2M_60")
save("EDDY_total_deaths_2M_60.mat","total_deaths_2M_60")

save("EDDY_case_paths_2M_80.mat","case_paths_2M_80")
save("EDDY_total_deaths_2M_80.mat","total_deaths_2M_80")
