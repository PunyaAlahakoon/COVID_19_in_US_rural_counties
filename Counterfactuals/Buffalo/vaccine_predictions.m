52%run this for all the counties.  
tic
%read ind_posteriors:
...
save('BUFFALO_predicted_dose1_paths.mat','predicted_dose1_paths')
save('BUFFALO_predicted_dose2_paths.mat','predicted_dose2_paths')
