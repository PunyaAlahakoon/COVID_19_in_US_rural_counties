...
buffalo=load('hie_params_TOWNER.mat');
...
save('TOWNER_predicted_dose1_paths.mat','predicted_dose1_paths')
save('TOWNER_predicted_dose2_paths.mat','predicted_dose2_paths')
