...
towner=load('hie_params_TOWNER.mat');
...
save('TOWNER_case_paths.mat','predicted_case_paths')
save('TOWNER_predicted_total_deaths.mat','predicted_total_deaths')

save('TOWNER_case_paths_2W_20.mat','case_paths_2W_20')
save('total_deaths_2W_20.mat','total_deaths_2W_20')

save("TOWNER_case_paths_2W_60.mat","case_paths_2W_60")
save("total_deaths_2W_60.mat","total_deaths_2W_60")

save("TOWNER_case_paths_2W_80.mat","case_paths_2W_80")
save("TOWNER_total_deaths_2W_80.mat","total_deaths_2W_80")

save("TOWNER_case_paths_4W_20.mat","case_paths_4W_20")
save("total_deaths_4W_20.mat","total_deaths_4W_20")

save("TOWNER_case_paths_4W_60.mat","case_paths_4W_60")
save("TOWNER_total_deaths_4W_60.mat",'total_deaths_4W_60')

save("TOWNER_case_paths_4W_80.mat","case_paths_4W_80")
save("TOWNER_total_deaths_4W_80.mat","total_deaths_4W_80")

save("TOWNER_case_paths_2M_20.mat","case_paths_2M_20")
save("TOWNER_total_deaths_2M_20.mat","total_deaths_2M_20")

save("TOWNER_case_paths_2M_60.mat","case_paths_2M_60")
save("TOWNER_total_deaths_2M_60.mat","total_deaths_2M_60")

save("TOWNER_case_paths_2M_80.mat","case_paths_2M_80")
save("TOWNER_total_deaths_2M_80.mat","total_deaths_2M_80")
