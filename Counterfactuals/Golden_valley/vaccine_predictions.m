...
buffalo=load('hie_params_GOLDEN.mat');
...
save('GOLDEN_predicted_dose1_paths.mat','predicted_dose1_paths')
save('GOLDEN_predicted_dose2_paths.mat','predicted_dose2_paths')
