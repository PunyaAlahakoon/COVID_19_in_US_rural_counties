...
faulk=load('hie_params_FAULK.mat');
faulk=faulk.params;
...
%3 months
case_paths_3M_20=zeros(T,B);
total_deaths_3M_20=zeros(1,B); 

case_paths_3M_60=zeros(T,B);
total_deaths_3M_60=zeros(1,B); 

case_paths_3M_80=zeros(T,B);
total_deaths_3M_80=zeros(1,B); 
...
total_deaths_2M_80(i)=sum(inci_2M_80(end,2:3));
 ...
 %after 3 months of increasing FOI
[~,daily_3M_20,inci_3M_20]=sample_generator_null_model_x_weeks(times,par,N,count,1.2,90);
case_paths_3M_20(:,i)=daily_3M_20(:,1);
total_deaths_3M_20(i)=sum(inci_3M_20(end,2:3));

[~,daily_3M_60,inci_3M_60]=sample_generator_null_model_x_weeks(times,par,N,count,1.6,90);
case_paths_3M_60(:,i)=daily_3M_60(:,1);
total_deaths_3M_60(i)=sum(inci_3M_60(end,2:3));

[~,daily_3M_80,inci_3M_80]=sample_generator_null_model_x_weeks(times,par,N,count,1.8,90);
case_paths_3M_80(:,i)=daily_3M_80(:,1);
total_deaths_3M_80(i)=sum(inci_3M_80(end,2:3));
...
save('FAULK_case_paths.mat','predicted_case_paths')
save('FAULK_predicted_total_deaths.mat','predicted_total_deaths')

save('FAULK_case_paths_2W_20.mat','case_paths_2W_20')
save('FAULK_total_deaths_2W_20.mat','total_deaths_2W_20')

save("FAULK_case_paths_2W_60.mat","case_paths_2W_60")
save("FAULK_total_deaths_2W_60.mat","total_deaths_2W_60")

save("FAULK_case_paths_2W_80.mat","case_paths_2W_80")
save("FAULK_total_deaths_2W_80.mat","total_deaths_2W_80")

save("FAULK_case_paths_4W_20.mat","case_paths_4W_20")
save("FAULK_total_deaths_4W_20.mat","total_deaths_4W_20")

save("FAULK_case_paths_4W_60.mat","case_paths_4W_60")
save("FAULK_total_deaths_4W_60.mat",'total_deaths_4W_60')

save("FAULK_case_paths_4W_80.mat","case_paths_4W_80")
save("FAULK_total_deaths_4W_80.mat","total_deaths_4W_80")

save("FAULK_case_paths_2M_20.mat","case_paths_2M_20")
save("FAULK_total_deaths_2M_20.mat","total_deaths_2M_20")

save("FAULK_case_paths_2M_60.mat","case_paths_2M_60")
save("FAULK_total_deaths_2M_60.mat","total_deaths_2M_60")

save("FAULK_case_paths_2M_80.mat","case_paths_2M_80")
save("FAULK_total_deaths_2M_80.mat","total_deaths_2M_80")

save("FAULK_case_paths_3M_20.mat","case_paths_3M_20")
save("FAULK_total_deaths_3M_20.mat","total_deaths_3M_20")

save("FAULK_case_paths_3M_60.mat","case_paths_3M_60")
save("FAULK_total_deaths_3M_60.mat","total_deaths_3M_60")

save("FAULK_case_paths_3M_80.mat","case_paths_3M_80")
save("FAULK_total_deaths_3M_80.mat","total_deaths_3M_80")
