...
predicted_dose12_cum_163=zeros(2,B); %cumulative count at day 163
...
save('predicted_case_paths5.mat','predicted_case_paths')
save('predicted_total_deaths5.mat','predicted_total_deaths')
save('predicted_dose1_paths5.mat','predicted_dose1_paths')
save('predicted_dose2_paths5.mat','predicted_dose2_paths')
