...
save("hie_params_GOLDEN.mat","params");
save('accepted_case_paths_GOLDEN.mat',"accepted_case_paths");
save("dose1_paths1_GOLDEN.mat","dose1_paths");
save("dose2_paths1_GOLDEN.mat","dose2_paths");
save("ag_GOLDEN.mat","ag");
save("rho_m_GOLDEN.mat",'rho_m');
