...
function[params,case_path,dose1_path,dose2_path,ag0,rho0]=abc_hie_covid3(pop_N,y,ds,v1,v2,ind_pars,w_smc,e,hb,hb_sig,cor)
       ...
       %dists=zeros(n,7);
        %generate a sample paths;
          for i=1:n
            ...
            diss=distance_metrics_hie(daily_c,inci,cases,deaths,vaccines,vacc_cum,times,i);
            dists(i)=sqrt(sum(diss.^2));
               if any(dists(i)>e(i))
                   i=n;
                   break
               end
