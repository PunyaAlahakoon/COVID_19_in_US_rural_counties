...
save("hie_params_TOWNER.mat","params");
save('accepted_case_paths_TOWNER.mat',"accepted_case_paths");
save("dose1_paths1_TOWNER.mat","dose1_paths");
save("dose2_paths1_TOWNER.mat","dose2_paths");
save("ag_TOWNER.mat","ag");
save("rho_m_TOWNER.mat",'rho_m');
