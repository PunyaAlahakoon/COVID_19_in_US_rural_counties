...
save('para_MINER.mat','para_smc')
save('case_paths_MINER.mat',"accepted_case_paths")
save('dose1_paths_MINER.mat',"accepted_dose1_paths")
save('dose2_paths_MINER.mat',"accepted_dose2_paths")
save('w_smc_MINER.mat','w_smc')
save('AG_smc_MINER.mat','AG_smc')
save('sx_MINER.mat','sx')
