...
save('para_smc_Eddy.mat','para_smc')
save('case_paths_Eddy.mat',"accepted_case_paths")
save('dose1_paths_Eddy.mat',"accepted_dose1_paths")
save('dose2_paths_Eddy.mat',"accepted_dose2_paths")
save('w_smc_Eddy.mat','w_smc')
save('AG_smc_Eddy.mat','AG_smc')
save('sx_Eddy.mat','sx')
