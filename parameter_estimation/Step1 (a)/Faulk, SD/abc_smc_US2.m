...
save('para_smc_Faulk.mat','para_smc')
save('case_paths_Faulk.mat',"accepted_case_paths")
save('dose1_paths_Faulk.mat',"accepted_dose1_paths")
save('dose2_paths_Faulk.mat',"accepted_dose2_paths")
save('w_smc_Faulk.mat','w_smc')
save('AG_smc_Faulk.mat','AG_smc')
save('sx_Faulk.mat','sx')
